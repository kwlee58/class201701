...
literacy.roll <- read.xlsx("../data/literacy_RnB0309.xlsx", 1, startRow = 3, endRow  = 66, colIndex = c(3:7, 9, 20:45), colClasses = c(rep("character", 32)), header = FALSE, stringsAsFactors = FALSE)
...
qqplot(x = literacy.score[Red], y = literacy.score[Black], xlab = "Red", ylab = "Black")
```
