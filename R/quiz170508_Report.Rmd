...
# quiz0508$Q4.2[quiz0508$group == "Black" & quiz0508$Q4 == "가"] <- "400명은 죽는다"
# quiz0508$Q4.2[quiz0508$group == "Black" & quiz0508$Q4 == "나"] <- "모두 사망 않을 확률 1/3"
# quiz0508$Q4.2[quiz0508$group == "Red" & quiz0508$Q4 == "가"] <- "200명은 살린다"
# quiz0508$Q4.2[quiz0508$group == "Red" & quiz0508$Q4 == "나"] <- "모두 살릴 확률 1/3"
# quiz0508$Q4.2 <- quiz0508$Q4
quiz0508$Q4.2[Red] <- ifelse(quiz0508$Q4[Red] == "가", "200명/400명", ifelse(quiz0508$Q4[Red] == "나", "확률 1/3", NA))
quiz0508$Q4.2[Black] <- ifelse(quiz0508$Q4[Black] == "가", "200명/400명", ifelse(quiz0508$Q4[Black] == "나", "확률 1/3", NA))
str(quiz0508)
```
