...
# quiz1005$Q4.2[quiz1005$Q4.2 == "NA"] <- NA
...
```{r, PDI, echo = FALSE}
Q1.tbl.am <- addmargins(table(quiz1005$group, quiz1005$Q1, exclude = NULL), margin = 1)
colnames(Q1.tbl.am)[6] <- "결석"
rownames(Q1.tbl.am)[4] <- "계"
pander(Q1.tbl.am[-3, ], caption = "총소득 대비 가계처분가능소득")
...
Q2.tbl.am <- addmargins(table(quiz1005$group, quiz1005$Q2, exclude = NULL), margin = 1)
colnames(Q2.tbl.am)[5] <- "결석"
rownames(Q2.tbl.am)[4] <- "계"
pander(Q2.tbl.am[-3, ], "자영업자의 어려움")
...
pander(round(prop.table(Q2.tbl.am, margin = 1)[4,]*100, digits=1), caption = "자영업자의 어려움")
...
Q3.tbl.am <- addmargins(table(quiz1005$group, quiz1005$Q3, exclude = NULL), margin = 1)
...
Q4.tbl.e <- table(quiz1005$group, quiz1005$Q4.2, exclude = NULL)
Q4.tbl.am <- addmargins(Q4.tbl.e, margin = 1)
colnames(Q4.tbl.am)[3] <- "결석"
rownames(Q4.tbl.am)[4] <- "계"
pander(Q4.tbl.am[-3, ], caption = "장기기증의사")
```

##### % 비교.  

```{r, vote attitude in percentage, echo = FALSE}
Q4.tbl <- table(quiz1005$group, quiz1005$Q4.2)
