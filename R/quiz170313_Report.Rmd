...
quiz0313 <- read.xlsx("../data/quiz0313.xlsx", 1, startRow = 2, endRow = 163, colIndex = c(3:7, 9:15), colClasses=c(rep("character", 11)), stringsAsFactors = FALSE)
str(quiz0313)
