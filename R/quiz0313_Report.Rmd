...
quiz0313 <- read.xlsx("../data/quiz0313.xlsx", 1, startRow = 2, endRow = 163, colIndex = c(3:7, 9:14), colClasses=c(rep("character", 11)), stringsAsFactors=FALSE)
str(quiz0313)
names(quiz0313) <- c("dept", "id", "name", "year", "e.mail", "cell.no", "Q1", "Q2", "Q3", "Q4", "group")
