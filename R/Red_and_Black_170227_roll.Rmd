...
pander(red.names[1:25, ], caption = "Red")
```

<P style="page-break-before:always">

```{r, red.names.2, echo = FALSE}
pander(red.names[26:50, ], caption = "Red")
```

<P style="page-break-before:always">

```{r, red.names.3, echo = FALSE}
pander(red.names[51:nrow(red.names), ], caption = "Red")
```

<P style="page-break-before:always">

```{r, black.names, echo = FALSE}
pander(black.names[1:25, ], caption = "Black")
```

<P style="page-break-before:always">

```{r, black.names.2, echo = FALSE}
pander(black.names[26:50, ], caption = "Black", col.names = "")
```

<P style="page-break-before:always">

```{r, black.names.3, echo = FALSE}
pander(black.names[51:nrow(black.names), ], caption = "Black", col.names = "")
```
