...
pander(red.names[55:nrow(red.names), ], caption = "Red")
```
...
pander(black.names[28:54, ], caption = "Black", col.names = "")
```

<P style="page-break-before:always">

```{r, black.names.3, echo = FALSE}
pander(black.names[55:nrow(black.names), ], caption = "Black", col.names = "")
```

<!--
```{r, save}
save("class_roll", file = "./class_roll170303.RData")
# save.image("./red_and_black_170303_data.RData")
```
-->
