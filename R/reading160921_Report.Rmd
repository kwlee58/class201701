...
reading <- read.xlsx("../data/reading160921.xlsx", 1, startRow = 4, endRow = 104, colIndex = c(3:7, 9:32), colClasses = c(rep("character", 6), "numeric", rep("character", 2), rep("numeric", 4), rep("character", 7), rep("numeric", 2), rep("character", 7)), header = TRUE, stringsAsFactors = FALSE)
str(reading)
head(reading)
