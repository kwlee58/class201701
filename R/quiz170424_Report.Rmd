...
```{r, times, echo = FALSE}
tbl.q1 <- table(quiz0424$group, quiz0424$Q1, useNA = "always")
...
pander(Q4.tbl.am[-3, ])
# kable(table(quiz0424$group, quiz0424$Q4, exclude = NULL), caption = "손실회피심리")
```
...
# merge.tbl <- table(quiz0424$group, quiz0424$Q4)
